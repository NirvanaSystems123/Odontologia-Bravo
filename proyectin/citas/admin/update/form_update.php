...
#select sql
$id = $_GET['id'];
$sentencia = $db->prepare("SELECT * FROM reservas WHERE id=?"); //consulta para ver si  que el id coincida con el valor proporcionado
$resultado = $sentencia->execute([$id]);
$persona = $sentencia->fetch(PDO::FETCH_OBJ); //almacena datos del registro que se utiliza para llenar el formulario con los datos actuales de la reserva.
