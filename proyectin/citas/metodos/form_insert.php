<form action="metodos/insert.php" method="post">
    ...
    <div class="form-group">
        ...
        <select class="custom-select" id="servicio" name="servicio" required>
            ...
            <option value="REABILITACIÓN ORAL">REABILITACIÓN ORAL</option>
            <option value="ORTODONCIA">ORTODONCIA</option>
            <option value="PERIODONCIA">PERIODONCIA</option>
            <option value="ODONTOPEDRIATRIA">ODONTOPEDRIATRIA</option>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function esFechaValida(fecha) { //agarra un objeto de fecha como parámetro
        return fecha instanceof Date && !isNaN(fecha); // NaN = no es fecha invaliad
    }

    // Función para validar la fecha
    function validarFecha() {
        var fechaInput = document.getElementById("fecha"); //obtiene el valor del campo de fecha
        ...
        */
        ...
        //  Se colocaron únicamente los dias que deseó habilitar
        if (diaSemana !== 1 && diaSemana !== 2 && diaSemana !== 3 && diaSemana !== 4 && diaSemana !== 5) {
            fechaInput.value = ""; // Borrar la fecha seleccionada
            mensajeError.textContent = "Este día no se cuenta con servicio, selecciona uno distinto por favor.";
        } else {
